...
#   2. Run the taxonomy update pipeline (expand → validate → promote → normalise)
#
...
python "${WORKSPACE}/scripts/sync_public_aircraft_sources.py" \
    --cache-dir "${WORKSPACE}/cache/public_sources"
